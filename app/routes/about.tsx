...
const githubUrl =
  ...
  "https://github.com/nouploads/nouploads";
        ...
        <div className="space-y-8 text-muted-foreground">
          <section>
            ...
            <p className="mt-2">
              ...
              touches your files. The entire application is static HTML, CSS, and
              JavaScript.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside mt-3 space-y-2">
              ...
              <li>
                <strong className="text-foreground">Go offline.</strong> Turn
                on airplane mode after the page loads. Every tool still works —
            ...
            <div className="mt-3 space-y-3">
              <div>
                ...
                <code className="block bg-muted rounded px-3 py-2 text-sm mt-1">
                  ...
                  ghcr.io/nouploads/nouploads:latest
                </code>
              </div>
              <div>
